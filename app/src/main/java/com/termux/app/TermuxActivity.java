...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Bottom nav bar
        View btnTerminal = findViewById(R.id.btn_nav_terminal);
        if (btnTerminal != null) btnTerminal.setOnClickListener(v -> {
            // already on terminal, just close drawer if open
            DrawerLayout dl = findViewById(R.id.drawer_layout);
            if (dl != null && dl.isDrawerOpen(Gravity.LEFT)) dl.closeDrawers();
        });
        View btnAi = findViewById(R.id.btn_nav_ai);
        if (btnAi != null) btnAi.setOnClickListener(v ->
            startActivity(new Intent(this, AiChatActivity.class)));
        View btnSettings = findViewById(R.id.btn_nav_settings);
